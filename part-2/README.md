...
This is **Part-2** of our analysis on the COVID-19 dataset provided by Johns Hopkins CSSE. In [**Part-1**](../part-1), I did data analysis on the dataset and created some tables and plots for getting insights from it. In Part-2, I'll focus on applying machine learning for making a prediction using time-series API's provided by ML.Net framework. I'll be building a model from scratch on the number of confirmed cases and predicting for the next 7 days. Later on, I'll plot these numbers for better visualization.
...
<img src="assets\confirmed-time-before.png" alt="Confirmed cases over time" style="zoom:80%;" />
...
<img src="assets\confirmed-time-after.png" alt="Confirmed cases after prediction" style="zoom:80%;" />
